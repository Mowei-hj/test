<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入标题名称" style="width: 200px" v-model="name"></el-input>
    ...
    <el-dialog title="经验详情" :visible.sync="viewVisible" width="55%" :close-on-click-modal="false" destroy-on-close>
