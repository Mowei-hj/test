<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入器材名称查询" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="器材图片" show-overflow-tooltip>
        ...
        <el-table-column prop="name" label="器材名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="location" label="器材位置"></el-table-column>
        <el-table-column prop="code" label="器材编号"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form">
        <el-form-item prop="img" label="器材图片">
          <el-upload
        ...
        <el-form-item prop="location" label="器材位置">
          <el-input v-model="form.location" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="code" label="器材编号">
