<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入菜谱名称" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="菜谱图片" show-overflow-tooltip>
        ...
        <el-table-column prop="name" label="菜谱名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="content" label="菜谱详情" show-overflow-tooltip>
          <template v-slot="scope">
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="img" label="菜谱图片">
          <el-upload
        ...
        <el-form-item prop="content" label="菜谱详情">
          <div id="editor"></div>
        </el-form-item>
      </el-form>
